/**
 * Login Page for Multi-Tenant SaaS
 */
import { useState, useEffect } from 'react'
import { Link, useNavigate } from 'react-router-dom'
import { useAuthStore } from '../stores/authStore'
import { Factory, Mail, Lock, Loader2, AlertCircle } from 'lucide-react'

export default function Login() {
  const [email, setEmail] = useState('')
  const [password, setPassword] = useState('')
  const [error, setError] = useState('')
  const { login, isLoading, isAuthenticated, organization } = useAuthStore()
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Sistema de Gestión de Plantas de Tratamiento
          </p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          © {new Date().getFullYear()} PTAR SaaS. Todos los derechos reservados.
        </p>
      </div>
    </div>
  )
